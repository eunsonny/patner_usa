  ...
  return (
    <div className={cx("start")}>
      <div className={cx("container")}>
        <span className={cx("firstLine")}>Innovation rental car computing systems,</span>
        ...
        <p className={cx("bottomP")}>
          ...
          the employee management. <span className={cx("login")} onClick={() => Router.push("/user/login")}>Log in</span>
        </p>
      </div>
    </div>
  );
