...
const LandingFour = () => {
  return (
    <div className={cx("landingFour")}>
      <div className={cx("container")}>
        <span className={cx("title")}>INTELLIGENT</span><br></br>
        <span className={cx("title")}>MOBILITY</span><br></br>
        <span className={cx("title")}>SYSTEM</span><br></br>
